...
inFile <- paste0(baseDir,"/samples4.txt")
...
# #######################################################
# 
# inFile <- paste0(baseDir,"/output/tmp_hartwig_clinically_actionable_pcgr_entries.txt")
...
# table(iMatchPair)
# 
# iMatchALKPair <- caFusions$name %in% c("EML4_ALK")
# table(iMatchALKPair)
